#############################################################################
# Makefile for building: netfilter_
# Generated by qmake (3.1) (Qt 6.1.2)
# Project:  ../netfilter_/netfilter_.pro
# Template: app
# Command: /opt/Qt/6.1.2/gcc_64/bin/qmake -o Makefile ../netfilter_/netfilter_.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../netfilter_ -I. -I/opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = netfilter_1.0.0
DISTDIR = /home/kali/build-netfilter_-Desktop_Qt_6_1_2_GCC_64bit-Debug/.tmp/netfilter_1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../netfilter_/netfilter_.pro  ../netfilter_/main.cpp
QMAKE_TARGET  = netfilter_
DESTDIR       = 
TARGET        = netfilter_
...
Makefile: ../netfilter_/netfilter_.pro /opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/6.1.2/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/features/lex.prf \
		../netfilter_/netfilter_.pro
	$(QMAKE) -o Makefile ../netfilter_/netfilter_.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
main.o: ../netfilter_/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../netfilter_/main.cpp
